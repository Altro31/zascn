...
import { DataTablePageSizeSelector } from './data-table-page-size-selector';
...
import { useMediaQueryStringOrFunction } from '@/components/datagrid/pagination/hooks';
import type { PaginationRenderContext } from '@/components/datagrid/pagination/types';
...
export function DataTablePagination({
	...
	const from = totalRecords
		? (page - 1) * (recordsPerPage ?? 0) + 1
		: undefined;
	...
	return (
		...
		>
			{typeof renderPagination === 'function' ? (
				...
				<>
					<Controls.Text className='flex-none' />
